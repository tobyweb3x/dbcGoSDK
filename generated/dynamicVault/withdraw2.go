...
type Withdraw2Instruction struct {
	UnmintAmount *uint64
	MinOutAmount *uint64
...
// NewWithdraw2InstructionBuilder creates a new `Withdraw2Instruction` instruction builder.
func NewWithdraw2InstructionBuilder() *Withdraw2Instruction {
	nd := &Withdraw2Instruction{
...
func (inst *Withdraw2Instruction) SetUnmintAmount(unmint_amount uint64) *Withdraw2Instruction {
	inst.UnmintAmount = &unmint_amount
	return inst
}

// SetMinOutAmount sets the "min_out_amount" parameter.
func (inst *Withdraw2Instruction) SetMinOutAmount(min_out_amount uint64) *Withdraw2Instruction {
...
// vault
func (inst *Withdraw2Instruction) SetVaultAccount(vault ag_solanago.PublicKey) *Withdraw2Instruction {
...
// vault
func (inst *Withdraw2Instruction) GetVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetTokenVaultAccount sets the "token_vault" account.
// token_vault
func (inst *Withdraw2Instruction) SetTokenVaultAccount(tokenVault ag_solanago.PublicKey) *Withdraw2Instruction {
...
// token_vault
func (inst *Withdraw2Instruction) GetTokenVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetLpMintAccount sets the "lp_mint" account.
// lp_mint
func (inst *Withdraw2Instruction) SetLpMintAccount(lpMint ag_solanago.PublicKey) *Withdraw2Instruction {
...
// lp_mint
func (inst *Withdraw2Instruction) GetLpMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetUserTokenAccount sets the "user_token" account.
// user_token
func (inst *Withdraw2Instruction) SetUserTokenAccount(userToken ag_solanago.PublicKey) *Withdraw2Instruction {
...
// user_token
func (inst *Withdraw2Instruction) GetUserTokenAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetUserLpAccount sets the "user_lp" account.
// user_lp
func (inst *Withdraw2Instruction) SetUserLpAccount(userLp ag_solanago.PublicKey) *Withdraw2Instruction {
...
// user_lp
func (inst *Withdraw2Instruction) GetUserLpAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetUserAccount sets the "user" account.
// user
func (inst *Withdraw2Instruction) SetUserAccount(user ag_solanago.PublicKey) *Withdraw2Instruction {
...
// user
func (inst *Withdraw2Instruction) GetUserAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetTokenProgramAccount sets the "token_program" account.
// token_program
func (inst *Withdraw2Instruction) SetTokenProgramAccount(tokenProgram ag_solanago.PublicKey) *Withdraw2Instruction {
...
// token_program
func (inst *Withdraw2Instruction) GetTokenProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

func (inst Withdraw2Instruction) Build() *Instruction {
...
func (inst Withdraw2Instruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *Withdraw2Instruction) Validate() error {
...
func (inst *Withdraw2Instruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj Withdraw2Instruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *Withdraw2Instruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
...
func NewWithdraw2Instruction(
	...
	tokenProgram ag_solanago.PublicKey) *Withdraw2Instruction {
