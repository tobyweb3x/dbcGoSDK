...
type DepositStrategyInstruction struct {
	Amount *uint64
...
// NewDepositStrategyInstructionBuilder creates a new `DepositStrategyInstruction` instruction builder.
func NewDepositStrategyInstructionBuilder() *DepositStrategyInstruction {
	nd := &DepositStrategyInstruction{
...
func (inst *DepositStrategyInstruction) SetAmount(amount uint64) *DepositStrategyInstruction {
	inst.Amount = &amount
	return inst
}
...
// vault
func (inst *DepositStrategyInstruction) SetVaultAccount(vault ag_solanago.PublicKey) *DepositStrategyInstruction {
...
// vault
func (inst *DepositStrategyInstruction) GetVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetStrategyAccount sets the "strategy" account.
// strategy
func (inst *DepositStrategyInstruction) SetStrategyAccount(strategy ag_solanago.PublicKey) *DepositStrategyInstruction {
...
// strategy
func (inst *DepositStrategyInstruction) GetStrategyAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetTokenVaultAccount sets the "token_vault" account.
// token_vault
func (inst *DepositStrategyInstruction) SetTokenVaultAccount(tokenVault ag_solanago.PublicKey) *DepositStrategyInstruction {
...
// token_vault
func (inst *DepositStrategyInstruction) GetTokenVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetFeeVaultAccount sets the "fee_vault" account.
// fee_vault
func (inst *DepositStrategyInstruction) SetFeeVaultAccount(feeVault ag_solanago.PublicKey) *DepositStrategyInstruction {
...
// fee_vault
func (inst *DepositStrategyInstruction) GetFeeVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetLpMintAccount sets the "lp_mint" account.
// lp_mint
func (inst *DepositStrategyInstruction) SetLpMintAccount(lpMint ag_solanago.PublicKey) *DepositStrategyInstruction {
...
// lp_mint
func (inst *DepositStrategyInstruction) GetLpMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetStrategyProgramAccount sets the "strategy_program" account.
func (inst *DepositStrategyInstruction) SetStrategyProgramAccount(strategyProgram ag_solanago.PublicKey) *DepositStrategyInstruction {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(strategyProgram)
	return inst
}

// GetStrategyProgramAccount gets the "strategy_program" account.
func (inst *DepositStrategyInstruction) GetStrategyProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetCollateralVaultAccount sets the "collateral_vault" account.
// collateral_vault
func (inst *DepositStrategyInstruction) SetCollateralVaultAccount(collateralVault ag_solanago.PublicKey) *DepositStrategyInstruction {
...
// collateral_vault
func (inst *DepositStrategyInstruction) GetCollateralVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetReserveAccount sets the "reserve" account.
func (inst *DepositStrategyInstruction) SetReserveAccount(reserve ag_solanago.PublicKey) *DepositStrategyInstruction {
	inst.AccountMetaSlice[7] = ag_solanago.Meta(reserve).WRITE()
	return inst
}

// GetReserveAccount gets the "reserve" account.
func (inst *DepositStrategyInstruction) GetReserveAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetTokenProgramAccount sets the "token_program" account.
// token_program
func (inst *DepositStrategyInstruction) SetTokenProgramAccount(tokenProgram ag_solanago.PublicKey) *DepositStrategyInstruction {
...
// token_program
func (inst *DepositStrategyInstruction) GetTokenProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetOperatorAccount sets the "operator" account.
// operator
func (inst *DepositStrategyInstruction) SetOperatorAccount(operator ag_solanago.PublicKey) *DepositStrategyInstruction {
...
// operator
func (inst *DepositStrategyInstruction) GetOperatorAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

func (inst DepositStrategyInstruction) Build() *Instruction {
...
func (inst DepositStrategyInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *DepositStrategyInstruction) Validate() error {
...
func (inst *DepositStrategyInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj DepositStrategyInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *DepositStrategyInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Deserialize `Amount`:
...
func NewDepositStrategyInstruction(
	...
	operator ag_solanago.PublicKey) *DepositStrategyInstruction {
