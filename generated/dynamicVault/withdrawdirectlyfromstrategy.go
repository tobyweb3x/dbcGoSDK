...
type WithdrawDirectlyFromStrategyInstruction struct {
	UnmintAmount *uint64
	MinOutAmount *uint64
...
// NewWithdrawDirectlyFromStrategyInstructionBuilder creates a new `WithdrawDirectlyFromStrategyInstruction` instruction builder.
func NewWithdrawDirectlyFromStrategyInstructionBuilder() *WithdrawDirectlyFromStrategyInstruction {
	nd := &WithdrawDirectlyFromStrategyInstruction{
...
func (inst *WithdrawDirectlyFromStrategyInstruction) SetUnmintAmount(unmint_amount uint64) *WithdrawDirectlyFromStrategyInstruction {
	inst.UnmintAmount = &unmint_amount
	return inst
}

// SetMinOutAmount sets the "min_out_amount" parameter.
func (inst *WithdrawDirectlyFromStrategyInstruction) SetMinOutAmount(min_out_amount uint64) *WithdrawDirectlyFromStrategyInstruction {
...
// vault
func (inst *WithdrawDirectlyFromStrategyInstruction) SetVaultAccount(vault ag_solanago.PublicKey) *WithdrawDirectlyFromStrategyInstruction {
...
// vault
func (inst *WithdrawDirectlyFromStrategyInstruction) GetVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetStrategyAccount sets the "strategy" account.
// strategy
func (inst *WithdrawDirectlyFromStrategyInstruction) SetStrategyAccount(strategy ag_solanago.PublicKey) *WithdrawDirectlyFromStrategyInstruction {
...
// strategy
func (inst *WithdrawDirectlyFromStrategyInstruction) GetStrategyAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetReserveAccount sets the "reserve" account.
func (inst *WithdrawDirectlyFromStrategyInstruction) SetReserveAccount(reserve ag_solanago.PublicKey) *WithdrawDirectlyFromStrategyInstruction {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(reserve).WRITE()
	return inst
}

// GetReserveAccount gets the "reserve" account.
func (inst *WithdrawDirectlyFromStrategyInstruction) GetReserveAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetStrategyProgramAccount sets the "strategy_program" account.
func (inst *WithdrawDirectlyFromStrategyInstruction) SetStrategyProgramAccount(strategyProgram ag_solanago.PublicKey) *WithdrawDirectlyFromStrategyInstruction {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(strategyProgram)
	return inst
}

// GetStrategyProgramAccount gets the "strategy_program" account.
func (inst *WithdrawDirectlyFromStrategyInstruction) GetStrategyProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetCollateralVaultAccount sets the "collateral_vault" account.
// collateral_vault
func (inst *WithdrawDirectlyFromStrategyInstruction) SetCollateralVaultAccount(collateralVault ag_solanago.PublicKey) *WithdrawDirectlyFromStrategyInstruction {
...
// collateral_vault
func (inst *WithdrawDirectlyFromStrategyInstruction) GetCollateralVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetTokenVaultAccount sets the "token_vault" account.
// token_vault
func (inst *WithdrawDirectlyFromStrategyInstruction) SetTokenVaultAccount(tokenVault ag_solanago.PublicKey) *WithdrawDirectlyFromStrategyInstruction {
...
// token_vault
func (inst *WithdrawDirectlyFromStrategyInstruction) GetTokenVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetLpMintAccount sets the "lp_mint" account.
// lp_mint
func (inst *WithdrawDirectlyFromStrategyInstruction) SetLpMintAccount(lpMint ag_solanago.PublicKey) *WithdrawDirectlyFromStrategyInstruction {
...
// lp_mint
func (inst *WithdrawDirectlyFromStrategyInstruction) GetLpMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetFeeVaultAccount sets the "fee_vault" account.
// fee_vault
func (inst *WithdrawDirectlyFromStrategyInstruction) SetFeeVaultAccount(feeVault ag_solanago.PublicKey) *WithdrawDirectlyFromStrategyInstruction {
...
// fee_vault
func (inst *WithdrawDirectlyFromStrategyInstruction) GetFeeVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetUserTokenAccount sets the "user_token" account.
// user_token
func (inst *WithdrawDirectlyFromStrategyInstruction) SetUserTokenAccount(userToken ag_solanago.PublicKey) *WithdrawDirectlyFromStrategyInstruction {
...
// user_token
func (inst *WithdrawDirectlyFromStrategyInstruction) GetUserTokenAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetUserLpAccount sets the "user_lp" account.
// user_lp
func (inst *WithdrawDirectlyFromStrategyInstruction) SetUserLpAccount(userLp ag_solanago.PublicKey) *WithdrawDirectlyFromStrategyInstruction {
...
// user_lp
func (inst *WithdrawDirectlyFromStrategyInstruction) GetUserLpAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

// SetUserAccount sets the "user" account.
// user
func (inst *WithdrawDirectlyFromStrategyInstruction) SetUserAccount(user ag_solanago.PublicKey) *WithdrawDirectlyFromStrategyInstruction {
...
// user
func (inst *WithdrawDirectlyFromStrategyInstruction) GetUserAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(10)
}

// SetTokenProgramAccount sets the "token_program" account.
// token_program
func (inst *WithdrawDirectlyFromStrategyInstruction) SetTokenProgramAccount(tokenProgram ag_solanago.PublicKey) *WithdrawDirectlyFromStrategyInstruction {
...
// token_program
func (inst *WithdrawDirectlyFromStrategyInstruction) GetTokenProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(11)
}

func (inst WithdrawDirectlyFromStrategyInstruction) Build() *Instruction {
...
func (inst WithdrawDirectlyFromStrategyInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *WithdrawDirectlyFromStrategyInstruction) Validate() error {
...
func (inst *WithdrawDirectlyFromStrategyInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj WithdrawDirectlyFromStrategyInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *WithdrawDirectlyFromStrategyInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
...
func NewWithdrawDirectlyFromStrategyInstruction(
	...
	tokenProgram ag_solanago.PublicKey) *WithdrawDirectlyFromStrategyInstruction {
