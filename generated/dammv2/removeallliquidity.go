...
// NewRemoveAllLiquidityInstructionBuilder creates a new `RemoveAllLiquidityInstruction` instruction builder.
func NewRemoveAllLiquidityInstructionBuilder() *RemoveAllLiquidityInstruction {
	nd := &RemoveAllLiquidityInstruction{
...
func (inst *RemoveAllLiquidityInstruction) SetTokenAAmountThreshold(token_a_amount_threshold uint64) *RemoveAllLiquidityInstruction {
	inst.TokenAAmountThreshold = &token_a_amount_threshold
	return inst
}

// SetTokenBAmountThreshold sets the "token_b_amount_threshold" parameter.
func (inst *RemoveAllLiquidityInstruction) SetTokenBAmountThreshold(token_b_amount_threshold uint64) *RemoveAllLiquidityInstruction {
	inst.TokenBAmountThreshold = &token_b_amount_threshold
	return inst
}

// SetPoolAuthorityAccount sets the "pool_authority" account.
func (inst *RemoveAllLiquidityInstruction) SetPoolAuthorityAccount(poolAuthority ag_solanago.PublicKey) *RemoveAllLiquidityInstruction {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(poolAuthority)
	return inst
}

func (inst *RemoveAllLiquidityInstruction) findFindPoolAuthorityAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
...
func (inst *RemoveAllLiquidityInstruction) FindPoolAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindPoolAuthorityAddress(bumpSeed)
	return
}

func (inst *RemoveAllLiquidityInstruction) MustFindPoolAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindPoolAuthorityAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *RemoveAllLiquidityInstruction) FindPoolAuthorityAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindPoolAuthorityAddress(0)
	return
}

func (inst *RemoveAllLiquidityInstruction) MustFindPoolAuthorityAddress() (pda ag_solanago.PublicKey) {
...
func (inst *RemoveAllLiquidityInstruction) GetPoolAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetPoolAccount sets the "pool" account.
func (inst *RemoveAllLiquidityInstruction) SetPoolAccount(pool ag_solanago.PublicKey) *RemoveAllLiquidityInstruction {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(pool).WRITE()
	return inst
}

// GetPoolAccount gets the "pool" account.
func (inst *RemoveAllLiquidityInstruction) GetPoolAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetPositionAccount sets the "position" account.
func (inst *RemoveAllLiquidityInstruction) SetPositionAccount(position ag_solanago.PublicKey) *RemoveAllLiquidityInstruction {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(position).WRITE()
	return inst
}

// GetPositionAccount gets the "position" account.
func (inst *RemoveAllLiquidityInstruction) GetPositionAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetTokenAAccountAccount sets the "token_a_account" account.
// The user token a account
func (inst *RemoveAllLiquidityInstruction) SetTokenAAccountAccount(tokenAAccount ag_solanago.PublicKey) *RemoveAllLiquidityInstruction {
...
// The user token a account
func (inst *RemoveAllLiquidityInstruction) GetTokenAAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetTokenBAccountAccount sets the "token_b_account" account.
// The user token b account
func (inst *RemoveAllLiquidityInstruction) SetTokenBAccountAccount(tokenBAccount ag_solanago.PublicKey) *RemoveAllLiquidityInstruction {
...
// The user token b account
func (inst *RemoveAllLiquidityInstruction) GetTokenBAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetTokenAVaultAccount sets the "token_a_vault" account.
// The vault token account for input token
func (inst *RemoveAllLiquidityInstruction) SetTokenAVaultAccount(tokenAVault ag_solanago.PublicKey) *RemoveAllLiquidityInstruction {
...
// The vault token account for input token
func (inst *RemoveAllLiquidityInstruction) GetTokenAVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetTokenBVaultAccount sets the "token_b_vault" account.
// The vault token account for output token
func (inst *RemoveAllLiquidityInstruction) SetTokenBVaultAccount(tokenBVault ag_solanago.PublicKey) *RemoveAllLiquidityInstruction {
...
// The vault token account for output token
func (inst *RemoveAllLiquidityInstruction) GetTokenBVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetTokenAMintAccount sets the "token_a_mint" account.
// The mint of token a
func (inst *RemoveAllLiquidityInstruction) SetTokenAMintAccount(tokenAMint ag_solanago.PublicKey) *RemoveAllLiquidityInstruction {
...
// The mint of token a
func (inst *RemoveAllLiquidityInstruction) GetTokenAMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetTokenBMintAccount sets the "token_b_mint" account.
// The mint of token b
func (inst *RemoveAllLiquidityInstruction) SetTokenBMintAccount(tokenBMint ag_solanago.PublicKey) *RemoveAllLiquidityInstruction {
...
// The mint of token b
func (inst *RemoveAllLiquidityInstruction) GetTokenBMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetPositionNftAccountAccount sets the "position_nft_account" account.
// The token account for nft
func (inst *RemoveAllLiquidityInstruction) SetPositionNftAccountAccount(positionNftAccount ag_solanago.PublicKey) *RemoveAllLiquidityInstruction {
...
// The token account for nft
func (inst *RemoveAllLiquidityInstruction) GetPositionNftAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

// SetOwnerAccount sets the "owner" account.
// owner of position
func (inst *RemoveAllLiquidityInstruction) SetOwnerAccount(owner ag_solanago.PublicKey) *RemoveAllLiquidityInstruction {
...
// owner of position
func (inst *RemoveAllLiquidityInstruction) GetOwnerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(10)
}

// SetTokenAProgramAccount sets the "token_a_program" account.
// Token a program
func (inst *RemoveAllLiquidityInstruction) SetTokenAProgramAccount(tokenAProgram ag_solanago.PublicKey) *RemoveAllLiquidityInstruction {
...
// Token a program
func (inst *RemoveAllLiquidityInstruction) GetTokenAProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(11)
}

// SetTokenBProgramAccount sets the "token_b_program" account.
// Token b program
func (inst *RemoveAllLiquidityInstruction) SetTokenBProgramAccount(tokenBProgram ag_solanago.PublicKey) *RemoveAllLiquidityInstruction {
...
// Token b program
func (inst *RemoveAllLiquidityInstruction) GetTokenBProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(12)
}

// SetEventAuthorityAccount sets the "event_authority" account.
func (inst *RemoveAllLiquidityInstruction) SetEventAuthorityAccount(eventAuthority ag_solanago.PublicKey) *RemoveAllLiquidityInstruction {
	inst.AccountMetaSlice[13] = ag_solanago.Meta(eventAuthority)
	return inst
}

func (inst *RemoveAllLiquidityInstruction) findFindEventAuthorityAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
...
func (inst *RemoveAllLiquidityInstruction) FindEventAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindEventAuthorityAddress(bumpSeed)
	return
}

func (inst *RemoveAllLiquidityInstruction) MustFindEventAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindEventAuthorityAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *RemoveAllLiquidityInstruction) FindEventAuthorityAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindEventAuthorityAddress(0)
	return
}

func (inst *RemoveAllLiquidityInstruction) MustFindEventAuthorityAddress() (pda ag_solanago.PublicKey) {
...
func (inst *RemoveAllLiquidityInstruction) GetEventAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(13)
}

// SetProgramAccount sets the "program" account.
func (inst *RemoveAllLiquidityInstruction) SetProgramAccount(program ag_solanago.PublicKey) *RemoveAllLiquidityInstruction {
	inst.AccountMetaSlice[14] = ag_solanago.Meta(program)
	return inst
}

// GetProgramAccount gets the "program" account.
func (inst *RemoveAllLiquidityInstruction) GetProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(14)
}

func (inst RemoveAllLiquidityInstruction) Build() *Instruction {
...
func (inst RemoveAllLiquidityInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *RemoveAllLiquidityInstruction) Validate() error {
...
func (inst *RemoveAllLiquidityInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj RemoveAllLiquidityInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *RemoveAllLiquidityInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
...
func NewRemoveAllLiquidityInstruction(
	...
	program ag_solanago.PublicKey) *RemoveAllLiquidityInstruction {
