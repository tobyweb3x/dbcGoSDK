...
func (inst *SwapInstruction) SetParams(params SwapParameters) *SwapInstruction {
	inst.Params = &params
	return inst
}

// SetPoolAuthorityAccount sets the "pool_authority" account.
func (inst *SwapInstruction) SetPoolAuthorityAccount(poolAuthority ag_solanago.PublicKey) *SwapInstruction {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(poolAuthority)
	return inst
}

func (inst *SwapInstruction) findFindPoolAuthorityAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
...
func (inst *SwapInstruction) FindPoolAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindPoolAuthorityAddress(bumpSeed)
	return
}

func (inst *SwapInstruction) MustFindPoolAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindPoolAuthorityAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *SwapInstruction) FindPoolAuthorityAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindPoolAuthorityAddress(0)
	return
}

func (inst *SwapInstruction) MustFindPoolAuthorityAddress() (pda ag_solanago.PublicKey) {
...
func (inst *SwapInstruction) GetPoolAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetPoolAccount sets the "pool" account.
// Pool account
func (inst *SwapInstruction) SetPoolAccount(pool ag_solanago.PublicKey) *SwapInstruction {
...
// Pool account
func (inst *SwapInstruction) GetPoolAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetInputTokenAccountAccount sets the "input_token_account" account.
// The user token account for input token
func (inst *SwapInstruction) SetInputTokenAccountAccount(inputTokenAccount ag_solanago.PublicKey) *SwapInstruction {
...
// The user token account for input token
func (inst *SwapInstruction) GetInputTokenAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetOutputTokenAccountAccount sets the "output_token_account" account.
// The user token account for output token
func (inst *SwapInstruction) SetOutputTokenAccountAccount(outputTokenAccount ag_solanago.PublicKey) *SwapInstruction {
...
// The user token account for output token
func (inst *SwapInstruction) GetOutputTokenAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetTokenAVaultAccount sets the "token_a_vault" account.
// The vault token account for input token
func (inst *SwapInstruction) SetTokenAVaultAccount(tokenAVault ag_solanago.PublicKey) *SwapInstruction {
...
// The vault token account for input token
func (inst *SwapInstruction) GetTokenAVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetTokenBVaultAccount sets the "token_b_vault" account.
// The vault token account for output token
func (inst *SwapInstruction) SetTokenBVaultAccount(tokenBVault ag_solanago.PublicKey) *SwapInstruction {
...
// The vault token account for output token
func (inst *SwapInstruction) GetTokenBVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetTokenAMintAccount sets the "token_a_mint" account.
// The mint of token a
func (inst *SwapInstruction) SetTokenAMintAccount(tokenAMint ag_solanago.PublicKey) *SwapInstruction {
...
// The mint of token a
func (inst *SwapInstruction) GetTokenAMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetTokenBMintAccount sets the "token_b_mint" account.
// The mint of token b
func (inst *SwapInstruction) SetTokenBMintAccount(tokenBMint ag_solanago.PublicKey) *SwapInstruction {
...
// The mint of token b
func (inst *SwapInstruction) GetTokenBMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetPayerAccount sets the "payer" account.
// The user performing the swap
func (inst *SwapInstruction) SetPayerAccount(payer ag_solanago.PublicKey) *SwapInstruction {
...
// The user performing the swap
func (inst *SwapInstruction) GetPayerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetTokenAProgramAccount sets the "token_a_program" account.
// Token a program
func (inst *SwapInstruction) SetTokenAProgramAccount(tokenAProgram ag_solanago.PublicKey) *SwapInstruction {
...
// Token a program
func (inst *SwapInstruction) GetTokenAProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

// SetTokenBProgramAccount sets the "token_b_program" account.
// Token b program
func (inst *SwapInstruction) SetTokenBProgramAccount(tokenBProgram ag_solanago.PublicKey) *SwapInstruction {
...
// Token b program
func (inst *SwapInstruction) GetTokenBProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(10)
}

// SetReferralTokenAccountAccount sets the "referral_token_account" account.
// referral token account
func (inst *SwapInstruction) SetReferralTokenAccountAccount(referralTokenAccount ag_solanago.PublicKey) *SwapInstruction {
...
// referral token account
func (inst *SwapInstruction) GetReferralTokenAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(11)
}

// SetEventAuthorityAccount sets the "event_authority" account.
func (inst *SwapInstruction) SetEventAuthorityAccount(eventAuthority ag_solanago.PublicKey) *SwapInstruction {
	inst.AccountMetaSlice[12] = ag_solanago.Meta(eventAuthority)
	return inst
}

func (inst *SwapInstruction) findFindEventAuthorityAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
...
func (inst *SwapInstruction) FindEventAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindEventAuthorityAddress(bumpSeed)
	return
}

func (inst *SwapInstruction) MustFindEventAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindEventAuthorityAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *SwapInstruction) FindEventAuthorityAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindEventAuthorityAddress(0)
	return
}

func (inst *SwapInstruction) MustFindEventAuthorityAddress() (pda ag_solanago.PublicKey) {
...
func (inst *SwapInstruction) GetEventAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(12)
}

// SetProgramAccount sets the "program" account.
func (inst *SwapInstruction) SetProgramAccount(program ag_solanago.PublicKey) *SwapInstruction {
	inst.AccountMetaSlice[13] = ag_solanago.Meta(program)
	return inst
}

// GetProgramAccount gets the "program" account.
func (inst *SwapInstruction) GetProgramAccount() *ag_solanago.AccountMeta {
...
func NewSwapInstruction(
	...
	program ag_solanago.PublicKey) *SwapInstruction {
