...
type ClaimPositionFeeInstruction struct {
...
// NewClaimPositionFeeInstructionBuilder creates a new `ClaimPositionFeeInstruction` instruction builder.
func NewClaimPositionFeeInstructionBuilder() *ClaimPositionFeeInstruction {
	nd := &ClaimPositionFeeInstruction{
...
func (inst *ClaimPositionFeeInstruction) SetPoolAuthorityAccount(poolAuthority ag_solanago.PublicKey) *ClaimPositionFeeInstruction {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(poolAuthority)
	return inst
}

func (inst *ClaimPositionFeeInstruction) findFindPoolAuthorityAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
...
func (inst *ClaimPositionFeeInstruction) FindPoolAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindPoolAuthorityAddress(bumpSeed)
	return
}

func (inst *ClaimPositionFeeInstruction) MustFindPoolAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindPoolAuthorityAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *ClaimPositionFeeInstruction) FindPoolAuthorityAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindPoolAuthorityAddress(0)
	return
}

func (inst *ClaimPositionFeeInstruction) MustFindPoolAuthorityAddress() (pda ag_solanago.PublicKey) {
...
func (inst *ClaimPositionFeeInstruction) GetPoolAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetPoolAccount sets the "pool" account.
func (inst *ClaimPositionFeeInstruction) SetPoolAccount(pool ag_solanago.PublicKey) *ClaimPositionFeeInstruction {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(pool)
	return inst
}

// GetPoolAccount gets the "pool" account.
func (inst *ClaimPositionFeeInstruction) GetPoolAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetPositionAccount sets the "position" account.
func (inst *ClaimPositionFeeInstruction) SetPositionAccount(position ag_solanago.PublicKey) *ClaimPositionFeeInstruction {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(position).WRITE()
	return inst
}

// GetPositionAccount gets the "position" account.
func (inst *ClaimPositionFeeInstruction) GetPositionAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetTokenAAccountAccount sets the "token_a_account" account.
// The user token a account
func (inst *ClaimPositionFeeInstruction) SetTokenAAccountAccount(tokenAAccount ag_solanago.PublicKey) *ClaimPositionFeeInstruction {
...
// The user token a account
func (inst *ClaimPositionFeeInstruction) GetTokenAAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetTokenBAccountAccount sets the "token_b_account" account.
// The user token b account
func (inst *ClaimPositionFeeInstruction) SetTokenBAccountAccount(tokenBAccount ag_solanago.PublicKey) *ClaimPositionFeeInstruction {
...
// The user token b account
func (inst *ClaimPositionFeeInstruction) GetTokenBAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetTokenAVaultAccount sets the "token_a_vault" account.
// The vault token account for input token
func (inst *ClaimPositionFeeInstruction) SetTokenAVaultAccount(tokenAVault ag_solanago.PublicKey) *ClaimPositionFeeInstruction {
...
// The vault token account for input token
func (inst *ClaimPositionFeeInstruction) GetTokenAVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetTokenBVaultAccount sets the "token_b_vault" account.
// The vault token account for output token
func (inst *ClaimPositionFeeInstruction) SetTokenBVaultAccount(tokenBVault ag_solanago.PublicKey) *ClaimPositionFeeInstruction {
...
// The vault token account for output token
func (inst *ClaimPositionFeeInstruction) GetTokenBVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetTokenAMintAccount sets the "token_a_mint" account.
// The mint of token a
func (inst *ClaimPositionFeeInstruction) SetTokenAMintAccount(tokenAMint ag_solanago.PublicKey) *ClaimPositionFeeInstruction {
...
// The mint of token a
func (inst *ClaimPositionFeeInstruction) GetTokenAMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetTokenBMintAccount sets the "token_b_mint" account.
// The mint of token b
func (inst *ClaimPositionFeeInstruction) SetTokenBMintAccount(tokenBMint ag_solanago.PublicKey) *ClaimPositionFeeInstruction {
...
// The mint of token b
func (inst *ClaimPositionFeeInstruction) GetTokenBMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetPositionNftAccountAccount sets the "position_nft_account" account.
// The token account for nft
func (inst *ClaimPositionFeeInstruction) SetPositionNftAccountAccount(positionNftAccount ag_solanago.PublicKey) *ClaimPositionFeeInstruction {
...
// The token account for nft
func (inst *ClaimPositionFeeInstruction) GetPositionNftAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

// SetOwnerAccount sets the "owner" account.
// owner of position
func (inst *ClaimPositionFeeInstruction) SetOwnerAccount(owner ag_solanago.PublicKey) *ClaimPositionFeeInstruction {
...
// owner of position
func (inst *ClaimPositionFeeInstruction) GetOwnerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(10)
}

// SetTokenAProgramAccount sets the "token_a_program" account.
// Token a program
func (inst *ClaimPositionFeeInstruction) SetTokenAProgramAccount(tokenAProgram ag_solanago.PublicKey) *ClaimPositionFeeInstruction {
...
// Token a program
func (inst *ClaimPositionFeeInstruction) GetTokenAProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(11)
}

// SetTokenBProgramAccount sets the "token_b_program" account.
// Token b program
func (inst *ClaimPositionFeeInstruction) SetTokenBProgramAccount(tokenBProgram ag_solanago.PublicKey) *ClaimPositionFeeInstruction {
...
// Token b program
func (inst *ClaimPositionFeeInstruction) GetTokenBProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(12)
}

// SetEventAuthorityAccount sets the "event_authority" account.
func (inst *ClaimPositionFeeInstruction) SetEventAuthorityAccount(eventAuthority ag_solanago.PublicKey) *ClaimPositionFeeInstruction {
	inst.AccountMetaSlice[13] = ag_solanago.Meta(eventAuthority)
	return inst
}

func (inst *ClaimPositionFeeInstruction) findFindEventAuthorityAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
...
func (inst *ClaimPositionFeeInstruction) FindEventAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindEventAuthorityAddress(bumpSeed)
	return
}

func (inst *ClaimPositionFeeInstruction) MustFindEventAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindEventAuthorityAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *ClaimPositionFeeInstruction) FindEventAuthorityAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindEventAuthorityAddress(0)
	return
}

func (inst *ClaimPositionFeeInstruction) MustFindEventAuthorityAddress() (pda ag_solanago.PublicKey) {
...
func (inst *ClaimPositionFeeInstruction) GetEventAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(13)
}

// SetProgramAccount sets the "program" account.
func (inst *ClaimPositionFeeInstruction) SetProgramAccount(program ag_solanago.PublicKey) *ClaimPositionFeeInstruction {
	inst.AccountMetaSlice[14] = ag_solanago.Meta(program)
	return inst
}

// GetProgramAccount gets the "program" account.
func (inst *ClaimPositionFeeInstruction) GetProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(14)
}

func (inst ClaimPositionFeeInstruction) Build() *Instruction {
...
func (inst ClaimPositionFeeInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *ClaimPositionFeeInstruction) Validate() error {
...
func (inst *ClaimPositionFeeInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj ClaimPositionFeeInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	return nil
}
func (obj *ClaimPositionFeeInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	return nil
}
...
func NewClaimPositionFeeInstruction(
	...
	program ag_solanago.PublicKey) *ClaimPositionFeeInstruction {
