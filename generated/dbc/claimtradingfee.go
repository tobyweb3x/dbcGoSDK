...
type ClaimTradingFeeInstruction struct {
	MaxAmountA *uint64
	MaxAmountB *uint64
...
// NewClaimTradingFeeInstructionBuilder creates a new `ClaimTradingFeeInstruction` instruction builder.
func NewClaimTradingFeeInstructionBuilder() *ClaimTradingFeeInstruction {
	nd := &ClaimTradingFeeInstruction{
...
func (inst *ClaimTradingFeeInstruction) SetMaxAmountA(max_amount_a uint64) *ClaimTradingFeeInstruction {
	inst.MaxAmountA = &max_amount_a
	return inst
}

// SetMaxAmountB sets the "max_amount_b" parameter.
func (inst *ClaimTradingFeeInstruction) SetMaxAmountB(max_amount_b uint64) *ClaimTradingFeeInstruction {
	inst.MaxAmountB = &max_amount_b
	return inst
}

// SetPoolAuthorityAccount sets the "pool_authority" account.
func (inst *ClaimTradingFeeInstruction) SetPoolAuthorityAccount(poolAuthority ag_solanago.PublicKey) *ClaimTradingFeeInstruction {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(poolAuthority)
	return inst
}

// GetPoolAuthorityAccount gets the "pool_authority" account.
func (inst *ClaimTradingFeeInstruction) GetPoolAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetConfigAccount sets the "config" account.
func (inst *ClaimTradingFeeInstruction) SetConfigAccount(config ag_solanago.PublicKey) *ClaimTradingFeeInstruction {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(config)
	return inst
}

// GetConfigAccount gets the "config" account.
func (inst *ClaimTradingFeeInstruction) GetConfigAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetPoolAccount sets the "pool" account.
func (inst *ClaimTradingFeeInstruction) SetPoolAccount(pool ag_solanago.PublicKey) *ClaimTradingFeeInstruction {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(pool).WRITE()
	return inst
}

// GetPoolAccount gets the "pool" account.
func (inst *ClaimTradingFeeInstruction) GetPoolAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetTokenAAccountAccount sets the "token_a_account" account.
// The treasury token a account
func (inst *ClaimTradingFeeInstruction) SetTokenAAccountAccount(tokenAAccount ag_solanago.PublicKey) *ClaimTradingFeeInstruction {
...
// The treasury token a account
func (inst *ClaimTradingFeeInstruction) GetTokenAAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetTokenBAccountAccount sets the "token_b_account" account.
// The treasury token b account
func (inst *ClaimTradingFeeInstruction) SetTokenBAccountAccount(tokenBAccount ag_solanago.PublicKey) *ClaimTradingFeeInstruction {
...
// The treasury token b account
func (inst *ClaimTradingFeeInstruction) GetTokenBAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetBaseVaultAccount sets the "base_vault" account.
// The vault token account for input token
func (inst *ClaimTradingFeeInstruction) SetBaseVaultAccount(baseVault ag_solanago.PublicKey) *ClaimTradingFeeInstruction {
...
// The vault token account for input token
func (inst *ClaimTradingFeeInstruction) GetBaseVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetQuoteVaultAccount sets the "quote_vault" account.
// The vault token account for output token
func (inst *ClaimTradingFeeInstruction) SetQuoteVaultAccount(quoteVault ag_solanago.PublicKey) *ClaimTradingFeeInstruction {
...
// The vault token account for output token
func (inst *ClaimTradingFeeInstruction) GetQuoteVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetBaseMintAccount sets the "base_mint" account.
// The mint of token a
func (inst *ClaimTradingFeeInstruction) SetBaseMintAccount(baseMint ag_solanago.PublicKey) *ClaimTradingFeeInstruction {
...
// The mint of token a
func (inst *ClaimTradingFeeInstruction) GetBaseMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetQuoteMintAccount sets the "quote_mint" account.
// The mint of token b
func (inst *ClaimTradingFeeInstruction) SetQuoteMintAccount(quoteMint ag_solanago.PublicKey) *ClaimTradingFeeInstruction {
...
// The mint of token b
func (inst *ClaimTradingFeeInstruction) GetQuoteMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetFeeClaimerAccount sets the "fee_claimer" account.
func (inst *ClaimTradingFeeInstruction) SetFeeClaimerAccount(feeClaimer ag_solanago.PublicKey) *ClaimTradingFeeInstruction {
	inst.AccountMetaSlice[9] = ag_solanago.Meta(feeClaimer).SIGNER()
	return inst
}

// GetFeeClaimerAccount gets the "fee_claimer" account.
func (inst *ClaimTradingFeeInstruction) GetFeeClaimerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

// SetTokenBaseProgramAccount sets the "token_base_program" account.
// Token a program
func (inst *ClaimTradingFeeInstruction) SetTokenBaseProgramAccount(tokenBaseProgram ag_solanago.PublicKey) *ClaimTradingFeeInstruction {
...
// Token a program
func (inst *ClaimTradingFeeInstruction) GetTokenBaseProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(10)
}

// SetTokenQuoteProgramAccount sets the "token_quote_program" account.
// Token b program
func (inst *ClaimTradingFeeInstruction) SetTokenQuoteProgramAccount(tokenQuoteProgram ag_solanago.PublicKey) *ClaimTradingFeeInstruction {
...
// Token b program
func (inst *ClaimTradingFeeInstruction) GetTokenQuoteProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(11)
}

// SetEventAuthorityAccount sets the "event_authority" account.
func (inst *ClaimTradingFeeInstruction) SetEventAuthorityAccount(eventAuthority ag_solanago.PublicKey) *ClaimTradingFeeInstruction {
	inst.AccountMetaSlice[12] = ag_solanago.Meta(eventAuthority)
	return inst
}

func (inst *ClaimTradingFeeInstruction) findFindEventAuthorityAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
...
func (inst *ClaimTradingFeeInstruction) FindEventAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindEventAuthorityAddress(bumpSeed)
	return
}

func (inst *ClaimTradingFeeInstruction) MustFindEventAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindEventAuthorityAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *ClaimTradingFeeInstruction) FindEventAuthorityAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindEventAuthorityAddress(0)
	return
}

func (inst *ClaimTradingFeeInstruction) MustFindEventAuthorityAddress() (pda ag_solanago.PublicKey) {
...
func (inst *ClaimTradingFeeInstruction) GetEventAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(12)
}

// SetProgramAccount sets the "program" account.
func (inst *ClaimTradingFeeInstruction) SetProgramAccount(program ag_solanago.PublicKey) *ClaimTradingFeeInstruction {
	inst.AccountMetaSlice[13] = ag_solanago.Meta(program)
	return inst
}

// GetProgramAccount gets the "program" account.
func (inst *ClaimTradingFeeInstruction) GetProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(13)
}

func (inst ClaimTradingFeeInstruction) Build() *Instruction {
...
func (inst ClaimTradingFeeInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *ClaimTradingFeeInstruction) Validate() error {
...
func (inst *ClaimTradingFeeInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj ClaimTradingFeeInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *ClaimTradingFeeInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
...
func NewClaimTradingFeeInstruction(
	...
	program ag_solanago.PublicKey) *ClaimTradingFeeInstruction {
