...
var InstructionImplDef = ag_binary.NewVariantDefinition(
	...
	[]ag_binary.VariantType{
		{
			Name: "claim_creator_trading_fee", Type: (*ClaimCreatorTradingFeeInstruction)(nil),
		},
		{
			Name: "claim_protocol_fee", Type: (*ClaimProtocolFeeInstruction)(nil),
		},
		{
			Name: "claim_trading_fee", Type: (*ClaimTradingFeeInstruction)(nil),
		},
		{
			Name: "close_claim_fee_operator", Type: (*CloseClaimFeeOperatorInstruction)(nil),
		},
		{
		...
		{
			Name: "create_locker", Type: (*CreateLockerInstruction)(nil),
		},
		{
			Name: "create_partner_metadata", Type: (*CreatePartnerMetadataInstruction)(nil),
		},
		{
			Name: "create_virtual_pool_metadata", Type: (*CreateVirtualPoolMetadataInstruction)(nil),
		},
		{
			Name: "creator_withdraw_surplus", Type: (*CreatorWithdrawSurplusInstruction)(nil),
		},
		{
			Name: "initialize_virtual_pool_with_spl_token", Type: (*InitializeVirtualPoolWithSplTokenInstruction)(nil),
		},
		{
			Name: "initialize_virtual_pool_with_token2022", Type: (*InitializeVirtualPoolWithToken2022Instruction)(nil),
		},
		{
			Name: "migrate_meteora_damm", Type: (*MigrateMeteoraDammInstruction)(nil),
		},
		{
			Name: "migrate_meteora_damm_claim_lp_token", Type: (*MigrateMeteoraDammClaimLpTokenInstruction)(nil),
		},
		{
			Name: "migrate_meteora_damm_lock_lp_token", Type: (*MigrateMeteoraDammLockLpTokenInstruction)(nil),
		},
		{
			Name: "migration_damm_v2", Type: (*MigrationDammV2Instruction)(nil),
		},
		{
			Name: "migration_damm_v2_create_metadata", Type: (*MigrationDammV2CreateMetadataInstruction)(nil),
		},
		{
			Name: "migration_meteora_damm_create_metadata", Type: (*MigrationMeteoraDammCreateMetadataInstruction)(nil),
		},
		{
			Name: "partner_withdraw_surplus", Type: (*PartnerWithdrawSurplusInstruction)(nil),
		},
		{
			Name: "protocol_withdraw_surplus", Type: (*ProtocolWithdrawSurplusInstruction)(nil),
		},
		{
		...
		{
			Name: "withdraw_leftover", Type: (*WithdrawLeftoverInstruction)(nil),
		},
		{
			Name: "withdraw_migration_fee", Type: (*WithdrawMigrationFeeInstruction)(nil),
		},
	},
)
