...
type InitializePermissionlessPoolInstruction struct {
	CurveType    *CurveType
	TokenAAmount *uint64
	TokenBAmount *uint64
...
// NewInitializePermissionlessPoolInstructionBuilder creates a new `InitializePermissionlessPoolInstruction` instruction builder.
func NewInitializePermissionlessPoolInstructionBuilder() *InitializePermissionlessPoolInstruction {
	nd := &InitializePermissionlessPoolInstruction{
...
func (inst *InitializePermissionlessPoolInstruction) SetCurveType(curve_type CurveType) *InitializePermissionlessPoolInstruction {
	inst.CurveType = &curve_type
	return inst
}

// SetTokenAAmount sets the "token_a_amount" parameter.
func (inst *InitializePermissionlessPoolInstruction) SetTokenAAmount(token_a_amount uint64) *InitializePermissionlessPoolInstruction {
	inst.TokenAAmount = &token_a_amount
	return inst
}

// SetTokenBAmount sets the "token_b_amount" parameter.
func (inst *InitializePermissionlessPoolInstruction) SetTokenBAmount(token_b_amount uint64) *InitializePermissionlessPoolInstruction {
...
// Pool account (PDA address)
func (inst *InitializePermissionlessPoolInstruction) SetPoolAccount(pool ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
...
// Pool account (PDA address)
func (inst *InitializePermissionlessPoolInstruction) GetPoolAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetLpMintAccount sets the "lp_mint" account.
// LP token mint of the pool
func (inst *InitializePermissionlessPoolInstruction) SetLpMintAccount(lpMint ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
...
// LP token mint of the pool
func (inst *InitializePermissionlessPoolInstruction) GetLpMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetTokenAMintAccount sets the "token_a_mint" account.
// Token A mint of the pool. Eg: USDT
func (inst *InitializePermissionlessPoolInstruction) SetTokenAMintAccount(tokenAMint ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
...
// Token A mint of the pool. Eg: USDT
func (inst *InitializePermissionlessPoolInstruction) GetTokenAMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetTokenBMintAccount sets the "token_b_mint" account.
// Token B mint of the pool. Eg: USDC
func (inst *InitializePermissionlessPoolInstruction) SetTokenBMintAccount(tokenBMint ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
...
// Token B mint of the pool. Eg: USDC
func (inst *InitializePermissionlessPoolInstruction) GetTokenBMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetAVaultAccount sets the "a_vault" account.
// Vault account for token A. Token A of the pool will be deposit / withdraw from this vault account.
func (inst *InitializePermissionlessPoolInstruction) SetAVaultAccount(aVault ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
...
// Vault account for token A. Token A of the pool will be deposit / withdraw from this vault account.
func (inst *InitializePermissionlessPoolInstruction) GetAVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetBVaultAccount sets the "b_vault" account.
// Vault account for token B. Token B of the pool will be deposit / withdraw from this vault account.
func (inst *InitializePermissionlessPoolInstruction) SetBVaultAccount(bVault ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
...
// Vault account for token B. Token B of the pool will be deposit / withdraw from this vault account.
func (inst *InitializePermissionlessPoolInstruction) GetBVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetATokenVaultAccount sets the "a_token_vault" account.
// Token vault account of vault A
func (inst *InitializePermissionlessPoolInstruction) SetATokenVaultAccount(aTokenVault ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
...
// Token vault account of vault A
func (inst *InitializePermissionlessPoolInstruction) GetATokenVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetBTokenVaultAccount sets the "b_token_vault" account.
// Token vault account of vault B
func (inst *InitializePermissionlessPoolInstruction) SetBTokenVaultAccount(bTokenVault ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
...
// Token vault account of vault B
func (inst *InitializePermissionlessPoolInstruction) GetBTokenVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetAVaultLpMintAccount sets the "a_vault_lp_mint" account.
// LP token mint of vault A
func (inst *InitializePermissionlessPoolInstruction) SetAVaultLpMintAccount(aVaultLpMint ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
...
// LP token mint of vault A
func (inst *InitializePermissionlessPoolInstruction) GetAVaultLpMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetBVaultLpMintAccount sets the "b_vault_lp_mint" account.
// LP token mint of vault B
func (inst *InitializePermissionlessPoolInstruction) SetBVaultLpMintAccount(bVaultLpMint ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
...
// LP token mint of vault B
func (inst *InitializePermissionlessPoolInstruction) GetBVaultLpMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

// SetAVaultLpAccount sets the "a_vault_lp" account.
// LP token account of vault A. Used to receive/burn the vault LP upon deposit/withdraw from the vault.
func (inst *InitializePermissionlessPoolInstruction) SetAVaultLpAccount(aVaultLp ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
...
// LP token account of vault A. Used to receive/burn the vault LP upon deposit/withdraw from the vault.
func (inst *InitializePermissionlessPoolInstruction) GetAVaultLpAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(10)
}

// SetBVaultLpAccount sets the "b_vault_lp" account.
// LP token account of vault B. Used to receive/burn vault LP upon deposit/withdraw from the vault.
func (inst *InitializePermissionlessPoolInstruction) SetBVaultLpAccount(bVaultLp ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
...
// LP token account of vault B. Used to receive/burn vault LP upon deposit/withdraw from the vault.
func (inst *InitializePermissionlessPoolInstruction) GetBVaultLpAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(11)
}

// SetPayerTokenAAccount sets the "payer_token_a" account.
// Payer token account for pool token A mint. Used to bootstrap the pool with initial liquidity.
func (inst *InitializePermissionlessPoolInstruction) SetPayerTokenAAccount(payerTokenA ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
...
// Payer token account for pool token A mint. Used to bootstrap the pool with initial liquidity.
func (inst *InitializePermissionlessPoolInstruction) GetPayerTokenAAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(12)
}

// SetPayerTokenBAccount sets the "payer_token_b" account.
// Admin token account for pool token B mint. Used to bootstrap the pool with initial liquidity.
func (inst *InitializePermissionlessPoolInstruction) SetPayerTokenBAccount(payerTokenB ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
...
// Admin token account for pool token B mint. Used to bootstrap the pool with initial liquidity.
func (inst *InitializePermissionlessPoolInstruction) GetPayerTokenBAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(13)
}

// SetPayerPoolLpAccount sets the "payer_pool_lp" account.
func (inst *InitializePermissionlessPoolInstruction) SetPayerPoolLpAccount(payerPoolLp ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
	inst.AccountMetaSlice[14] = ag_solanago.Meta(payerPoolLp).WRITE()
	return inst
}

// GetPayerPoolLpAccount gets the "payer_pool_lp" account.
func (inst *InitializePermissionlessPoolInstruction) GetPayerPoolLpAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(14)
}

// SetProtocolTokenAFeeAccount sets the "protocol_token_a_fee" account.
// Protocol fee token account for token A. Used to receive trading fee.
func (inst *InitializePermissionlessPoolInstruction) SetProtocolTokenAFeeAccount(protocolTokenAFee ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
...
// Protocol fee token account for token A. Used to receive trading fee.
func (inst *InitializePermissionlessPoolInstruction) GetProtocolTokenAFeeAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(15)
}

// SetProtocolTokenBFeeAccount sets the "protocol_token_b_fee" account.
// Protocol fee token account for token B. Used to receive trading fee.
func (inst *InitializePermissionlessPoolInstruction) SetProtocolTokenBFeeAccount(protocolTokenBFee ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
...
// Protocol fee token account for token B. Used to receive trading fee.
func (inst *InitializePermissionlessPoolInstruction) GetProtocolTokenBFeeAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(16)
}

// SetPayerAccount sets the "payer" account.
// Admin account. This account will be the admin of the pool, and the payer for PDA during initialize pool.
func (inst *InitializePermissionlessPoolInstruction) SetPayerAccount(payer ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
...
// Admin account. This account will be the admin of the pool, and the payer for PDA during initialize pool.
func (inst *InitializePermissionlessPoolInstruction) GetPayerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(17)
}

// SetFeeOwnerAccount sets the "fee_owner" account.
func (inst *InitializePermissionlessPoolInstruction) SetFeeOwnerAccount(feeOwner ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
	inst.AccountMetaSlice[18] = ag_solanago.Meta(feeOwner)
	return inst
}

// GetFeeOwnerAccount gets the "fee_owner" account.
func (inst *InitializePermissionlessPoolInstruction) GetFeeOwnerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(18)
}

// SetRentAccount sets the "rent" account.
// Rent account.
func (inst *InitializePermissionlessPoolInstruction) SetRentAccount(rent ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
...
// Rent account.
func (inst *InitializePermissionlessPoolInstruction) GetRentAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(19)
}

// SetMintMetadataAccount sets the "mint_metadata" account.
func (inst *InitializePermissionlessPoolInstruction) SetMintMetadataAccount(mintMetadata ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
	inst.AccountMetaSlice[20] = ag_solanago.Meta(mintMetadata).WRITE()
	return inst
}

// GetMintMetadataAccount gets the "mint_metadata" account.
func (inst *InitializePermissionlessPoolInstruction) GetMintMetadataAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(20)
}

// SetMetadataProgramAccount sets the "metadata_program" account.
func (inst *InitializePermissionlessPoolInstruction) SetMetadataProgramAccount(metadataProgram ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
	inst.AccountMetaSlice[21] = ag_solanago.Meta(metadataProgram)
	return inst
}

// GetMetadataProgramAccount gets the "metadata_program" account.
func (inst *InitializePermissionlessPoolInstruction) GetMetadataProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(21)
}

// SetVaultProgramAccount sets the "vault_program" account.
// Vault program. The pool will deposit/withdraw liquidity from the vault.
func (inst *InitializePermissionlessPoolInstruction) SetVaultProgramAccount(vaultProgram ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
...
// Vault program. The pool will deposit/withdraw liquidity from the vault.
func (inst *InitializePermissionlessPoolInstruction) GetVaultProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(22)
}

// SetTokenProgramAccount sets the "token_program" account.
// Token program.
func (inst *InitializePermissionlessPoolInstruction) SetTokenProgramAccount(tokenProgram ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
...
// Token program.
func (inst *InitializePermissionlessPoolInstruction) GetTokenProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(23)
}

// SetAssociatedTokenProgramAccount sets the "associated_token_program" account.
// Associated token program.
func (inst *InitializePermissionlessPoolInstruction) SetAssociatedTokenProgramAccount(associatedTokenProgram ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
...
// Associated token program.
func (inst *InitializePermissionlessPoolInstruction) GetAssociatedTokenProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(24)
}

// SetSystemProgramAccount sets the "system_program" account.
// System program.
func (inst *InitializePermissionlessPoolInstruction) SetSystemProgramAccount(systemProgram ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
...
// System program.
func (inst *InitializePermissionlessPoolInstruction) GetSystemProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(25)
}

func (inst InitializePermissionlessPoolInstruction) Build() *Instruction {
...
func (inst InitializePermissionlessPoolInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *InitializePermissionlessPoolInstruction) Validate() error {
...
func (inst *InitializePermissionlessPoolInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj InitializePermissionlessPoolInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *InitializePermissionlessPoolInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
...
func NewInitializePermissionlessPoolInstruction(
	...
	systemProgram ag_solanago.PublicKey) *InitializePermissionlessPoolInstruction {
