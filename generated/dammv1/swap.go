...
func (inst *SwapInstruction) SetInAmount(in_amount uint64) *SwapInstruction {
	inst.InAmount = &in_amount
	return inst
}

// SetMinimumOutAmount sets the "minimum_out_amount" parameter.
func (inst *SwapInstruction) SetMinimumOutAmount(minimum_out_amount uint64) *SwapInstruction {
...
// User token account. Token from this account will be transfer into the vault by the pool in exchange for another token of the pool.
func (inst *SwapInstruction) SetUserSourceTokenAccount(userSourceToken ag_solanago.PublicKey) *SwapInstruction {
...
// User token account. Token from this account will be transfer into the vault by the pool in exchange for another token of the pool.
func (inst *SwapInstruction) GetUserSourceTokenAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetUserDestinationTokenAccount sets the "user_destination_token" account.
// User token account. The exchanged token will be transfer into this account from the pool.
func (inst *SwapInstruction) SetUserDestinationTokenAccount(userDestinationToken ag_solanago.PublicKey) *SwapInstruction {
...
// User token account. The exchanged token will be transfer into this account from the pool.
func (inst *SwapInstruction) GetUserDestinationTokenAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetAVaultAccount sets the "a_vault" account.
// Vault account for token a. token a of the pool will be deposit / withdraw from this vault account.
func (inst *SwapInstruction) SetAVaultAccount(aVault ag_solanago.PublicKey) *SwapInstruction {
...
// Vault account for token a. token a of the pool will be deposit / withdraw from this vault account.
func (inst *SwapInstruction) GetAVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetBVaultAccount sets the "b_vault" account.
// Vault account for token b. token b of the pool will be deposit / withdraw from this vault account.
func (inst *SwapInstruction) SetBVaultAccount(bVault ag_solanago.PublicKey) *SwapInstruction {
...
// Vault account for token b. token b of the pool will be deposit / withdraw from this vault account.
func (inst *SwapInstruction) GetBVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetATokenVaultAccount sets the "a_token_vault" account.
// Token vault account of vault A
func (inst *SwapInstruction) SetATokenVaultAccount(aTokenVault ag_solanago.PublicKey) *SwapInstruction {
...
// Token vault account of vault A
func (inst *SwapInstruction) GetATokenVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetBTokenVaultAccount sets the "b_token_vault" account.
// Token vault account of vault B
func (inst *SwapInstruction) SetBTokenVaultAccount(bTokenVault ag_solanago.PublicKey) *SwapInstruction {
...
// Token vault account of vault B
func (inst *SwapInstruction) GetBTokenVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetAVaultLpMintAccount sets the "a_vault_lp_mint" account.
// Lp token mint of vault a
func (inst *SwapInstruction) SetAVaultLpMintAccount(aVaultLpMint ag_solanago.PublicKey) *SwapInstruction {
...
// Lp token mint of vault a
func (inst *SwapInstruction) GetAVaultLpMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetBVaultLpMintAccount sets the "b_vault_lp_mint" account.
// Lp token mint of vault b
func (inst *SwapInstruction) SetBVaultLpMintAccount(bVaultLpMint ag_solanago.PublicKey) *SwapInstruction {
...
// Lp token mint of vault b
func (inst *SwapInstruction) GetBVaultLpMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetAVaultLpAccount sets the "a_vault_lp" account.
// LP token account of vault A. Used to receive/burn the vault LP upon deposit/withdraw from the vault.
func (inst *SwapInstruction) SetAVaultLpAccount(aVaultLp ag_solanago.PublicKey) *SwapInstruction {
...
// LP token account of vault A. Used to receive/burn the vault LP upon deposit/withdraw from the vault.
func (inst *SwapInstruction) GetAVaultLpAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

// SetBVaultLpAccount sets the "b_vault_lp" account.
// LP token account of vault B. Used to receive/burn the vault LP upon deposit/withdraw from the vault.
func (inst *SwapInstruction) SetBVaultLpAccount(bVaultLp ag_solanago.PublicKey) *SwapInstruction {
...
// LP token account of vault B. Used to receive/burn the vault LP upon deposit/withdraw from the vault.
func (inst *SwapInstruction) GetBVaultLpAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(10)
}

// SetProtocolTokenFeeAccount sets the "protocol_token_fee" account.
// Protocol fee token account. Used to receive trading fee. It's mint field must matched with user_source_token mint field.
func (inst *SwapInstruction) SetProtocolTokenFeeAccount(protocolTokenFee ag_solanago.PublicKey) *SwapInstruction {
...
// Protocol fee token account. Used to receive trading fee. It's mint field must matched with user_source_token mint field.
func (inst *SwapInstruction) GetProtocolTokenFeeAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(11)
}

// SetUserAccount sets the "user" account.
// User account. Must be owner of user_source_token.
func (inst *SwapInstruction) SetUserAccount(user ag_solanago.PublicKey) *SwapInstruction {
...
// User account. Must be owner of user_source_token.
func (inst *SwapInstruction) GetUserAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(12)
}

// SetVaultProgramAccount sets the "vault_program" account.
// Vault program. the pool will deposit/withdraw liquidity from the vault.
func (inst *SwapInstruction) SetVaultProgramAccount(vaultProgram ag_solanago.PublicKey) *SwapInstruction {
...
// Vault program. the pool will deposit/withdraw liquidity from the vault.
func (inst *SwapInstruction) GetVaultProgramAccount() *ag_solanago.AccountMeta {
...
func NewSwapInstruction(
	...
	tokenProgram ag_solanago.PublicKey) *SwapInstruction {
