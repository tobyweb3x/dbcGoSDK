...
type AddBalanceLiquidityInstruction struct {
...
// NewAddBalanceLiquidityInstructionBuilder creates a new `AddBalanceLiquidityInstruction` instruction builder.
func NewAddBalanceLiquidityInstructionBuilder() *AddBalanceLiquidityInstruction {
	nd := &AddBalanceLiquidityInstruction{
...
func (inst *AddBalanceLiquidityInstruction) SetPoolTokenAmount(pool_token_amount uint64) *AddBalanceLiquidityInstruction {
	inst.PoolTokenAmount = &pool_token_amount
	return inst
}

// SetMaximumTokenAAmount sets the "maximum_token_a_amount" parameter.
func (inst *AddBalanceLiquidityInstruction) SetMaximumTokenAAmount(maximum_token_a_amount uint64) *AddBalanceLiquidityInstruction {
	inst.MaximumTokenAAmount = &maximum_token_a_amount
	return inst
}

// SetMaximumTokenBAmount sets the "maximum_token_b_amount" parameter.
func (inst *AddBalanceLiquidityInstruction) SetMaximumTokenBAmount(maximum_token_b_amount uint64) *AddBalanceLiquidityInstruction {
...
// Pool account (PDA)
func (inst *AddBalanceLiquidityInstruction) SetPoolAccount(pool ag_solanago.PublicKey) *AddBalanceLiquidityInstruction {
...
// Pool account (PDA)
func (inst *AddBalanceLiquidityInstruction) GetPoolAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetLpMintAccount sets the "lp_mint" account.
// LP token mint of the pool
func (inst *AddBalanceLiquidityInstruction) SetLpMintAccount(lpMint ag_solanago.PublicKey) *AddBalanceLiquidityInstruction {
...
// LP token mint of the pool
func (inst *AddBalanceLiquidityInstruction) GetLpMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetUserPoolLpAccount sets the "user_pool_lp" account.
// user pool lp token account. lp will be burned from this account upon success liquidity removal.
func (inst *AddBalanceLiquidityInstruction) SetUserPoolLpAccount(userPoolLp ag_solanago.PublicKey) *AddBalanceLiquidityInstruction {
...
// user pool lp token account. lp will be burned from this account upon success liquidity removal.
func (inst *AddBalanceLiquidityInstruction) GetUserPoolLpAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetAVaultLpAccount sets the "a_vault_lp" account.
// LP token account of vault A. Used to receive/burn the vault LP upon deposit/withdraw from the vault.
func (inst *AddBalanceLiquidityInstruction) SetAVaultLpAccount(aVaultLp ag_solanago.PublicKey) *AddBalanceLiquidityInstruction {
...
// LP token account of vault A. Used to receive/burn the vault LP upon deposit/withdraw from the vault.
func (inst *AddBalanceLiquidityInstruction) GetAVaultLpAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetBVaultLpAccount sets the "b_vault_lp" account.
// LP token account of vault B. Used to receive/burn the vault LP upon deposit/withdraw from the vault.
func (inst *AddBalanceLiquidityInstruction) SetBVaultLpAccount(bVaultLp ag_solanago.PublicKey) *AddBalanceLiquidityInstruction {
...
// LP token account of vault B. Used to receive/burn the vault LP upon deposit/withdraw from the vault.
func (inst *AddBalanceLiquidityInstruction) GetBVaultLpAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetAVaultAccount sets the "a_vault" account.
// Vault account for token a. token a of the pool will be deposit / withdraw from this vault account.
func (inst *AddBalanceLiquidityInstruction) SetAVaultAccount(aVault ag_solanago.PublicKey) *AddBalanceLiquidityInstruction {
...
// Vault account for token a. token a of the pool will be deposit / withdraw from this vault account.
func (inst *AddBalanceLiquidityInstruction) GetAVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetBVaultAccount sets the "b_vault" account.
// Vault account for token b. token b of the pool will be deposit / withdraw from this vault account.
func (inst *AddBalanceLiquidityInstruction) SetBVaultAccount(bVault ag_solanago.PublicKey) *AddBalanceLiquidityInstruction {
...
// Vault account for token b. token b of the pool will be deposit / withdraw from this vault account.
func (inst *AddBalanceLiquidityInstruction) GetBVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetAVaultLpMintAccount sets the "a_vault_lp_mint" account.
// LP token mint of vault a
func (inst *AddBalanceLiquidityInstruction) SetAVaultLpMintAccount(aVaultLpMint ag_solanago.PublicKey) *AddBalanceLiquidityInstruction {
...
// LP token mint of vault a
func (inst *AddBalanceLiquidityInstruction) GetAVaultLpMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetBVaultLpMintAccount sets the "b_vault_lp_mint" account.
// LP token mint of vault b
func (inst *AddBalanceLiquidityInstruction) SetBVaultLpMintAccount(bVaultLpMint ag_solanago.PublicKey) *AddBalanceLiquidityInstruction {
...
// LP token mint of vault b
func (inst *AddBalanceLiquidityInstruction) GetBVaultLpMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetATokenVaultAccount sets the "a_token_vault" account.
// Token vault account of vault A
func (inst *AddBalanceLiquidityInstruction) SetATokenVaultAccount(aTokenVault ag_solanago.PublicKey) *AddBalanceLiquidityInstruction {
...
// Token vault account of vault A
func (inst *AddBalanceLiquidityInstruction) GetATokenVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

// SetBTokenVaultAccount sets the "b_token_vault" account.
// Token vault account of vault B
func (inst *AddBalanceLiquidityInstruction) SetBTokenVaultAccount(bTokenVault ag_solanago.PublicKey) *AddBalanceLiquidityInstruction {
...
// Token vault account of vault B
func (inst *AddBalanceLiquidityInstruction) GetBTokenVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(10)
}

// SetUserATokenAccount sets the "user_a_token" account.
// User token A account. Token will be transfer from this account if it is add liquidity operation. Else, token will be transfer into this account.
func (inst *AddBalanceLiquidityInstruction) SetUserATokenAccount(userAToken ag_solanago.PublicKey) *AddBalanceLiquidityInstruction {
...
// User token A account. Token will be transfer from this account if it is add liquidity operation. Else, token will be transfer into this account.
func (inst *AddBalanceLiquidityInstruction) GetUserATokenAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(11)
}

// SetUserBTokenAccount sets the "user_b_token" account.
// User token B account. Token will be transfer from this account if it is add liquidity operation. Else, token will be transfer into this account.
func (inst *AddBalanceLiquidityInstruction) SetUserBTokenAccount(userBToken ag_solanago.PublicKey) *AddBalanceLiquidityInstruction {
...
// User token B account. Token will be transfer from this account if it is add liquidity operation. Else, token will be transfer into this account.
func (inst *AddBalanceLiquidityInstruction) GetUserBTokenAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(12)
}

// SetUserAccount sets the "user" account.
// User account. Must be owner of user_a_token, and user_b_token.
func (inst *AddBalanceLiquidityInstruction) SetUserAccount(user ag_solanago.PublicKey) *AddBalanceLiquidityInstruction {
...
// User account. Must be owner of user_a_token, and user_b_token.
func (inst *AddBalanceLiquidityInstruction) GetUserAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(13)
}

// SetVaultProgramAccount sets the "vault_program" account.
// Vault program. the pool will deposit/withdraw liquidity from the vault.
func (inst *AddBalanceLiquidityInstruction) SetVaultProgramAccount(vaultProgram ag_solanago.PublicKey) *AddBalanceLiquidityInstruction {
...
// Vault program. the pool will deposit/withdraw liquidity from the vault.
func (inst *AddBalanceLiquidityInstruction) GetVaultProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(14)
}

// SetTokenProgramAccount sets the "token_program" account.
// Token program.
func (inst *AddBalanceLiquidityInstruction) SetTokenProgramAccount(tokenProgram ag_solanago.PublicKey) *AddBalanceLiquidityInstruction {
...
// Token program.
func (inst *AddBalanceLiquidityInstruction) GetTokenProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(15)
}

func (inst AddBalanceLiquidityInstruction) Build() *Instruction {
...
func (inst AddBalanceLiquidityInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *AddBalanceLiquidityInstruction) Validate() error {
...
func (inst *AddBalanceLiquidityInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj AddBalanceLiquidityInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *AddBalanceLiquidityInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
...
func NewAddBalanceLiquidityInstruction(
	...
	tokenProgram ag_solanago.PublicKey) *AddBalanceLiquidityInstruction {
