...
var InstructionImplDef = ag_binary.NewVariantDefinition(
	...
	[]ag_binary.VariantType{
		{
			Name: "initialize_permissioned_pool", Type: (*InitializePermissionedPoolInstruction)(nil),
		},
		{
			Name: "initialize_permissionless_pool", Type: (*InitializePermissionlessPoolInstruction)(nil),
		},
		{
			Name: "initialize_permissionless_pool_with_fee_tier", Type: (*InitializePermissionlessPoolWithFeeTierInstruction)(nil),
		},
		{
			Name: "enable_or_disable_pool", Type: (*EnableOrDisablePoolInstruction)(nil),
		},
		{
			Name: "swap", Type: (*SwapInstruction)(nil),
		},
		{
			Name: "remove_liquidity_single_side", Type: (*RemoveLiquiditySingleSideInstruction)(nil),
		},
		{
			Name: "add_imbalance_liquidity", Type: (*AddImbalanceLiquidityInstruction)(nil),
		},
		{
			Name: "remove_balance_liquidity", Type: (*RemoveBalanceLiquidityInstruction)(nil),
		},
		{
			Name: "add_balance_liquidity", Type: (*AddBalanceLiquidityInstruction)(nil),
		},
		{
			Name: "set_pool_fees", Type: (*SetPoolFeesInstruction)(nil),
		},
		{
			Name: "override_curve_param", Type: (*OverrideCurveParamInstruction)(nil),
		},
		{
			Name: "get_pool_info", Type: (*GetPoolInfoInstruction)(nil),
		},
		{
			Name: "bootstrap_liquidity", Type: (*BootstrapLiquidityInstruction)(nil),
		},
		{
			Name: "create_mint_metadata", Type: (*CreateMintMetadataInstruction)(nil),
		},
		{
			Name: "create_lock_escrow", Type: (*CreateLockEscrowInstruction)(nil),
		},
		{
			Name: "lock", Type: (*LockInstruction)(nil),
		},
		{
			Name: "claim_fee", Type: (*ClaimFeeInstruction)(nil),
		},
		{
			Name: "create_config", Type: (*CreateConfigInstruction)(nil),
		},
		{
			Name: "close_config", Type: (*CloseConfigInstruction)(nil),
		},
		{
			Name: "initialize_permissionless_constant_product_pool_with_config", Type: (*InitializePermissionlessConstantProductPoolWithConfigInstruction)(nil),
		},
		{
			Name: "initialize_permissionless_constant_product_pool_with_config2", Type: (*InitializePermissionlessConstantProductPoolWithConfig2Instruction)(nil),
		},
		{
			Name: "initialize_customizable_permissionless_constant_product_pool", Type: (*InitializeCustomizablePermissionlessConstantProductPoolInstruction)(nil),
		},
		{
			Name: "update_activation_point", Type: (*UpdateActivationPointInstruction)(nil),
		},
		{
			Name: "withdraw_protocol_fees", Type: (*WithdrawProtocolFeesInstruction)(nil),
		},
		{
			Name: "set_whitelisted_vault", Type: (*SetWhitelistedVaultInstruction)(nil),
		},
		{
			Name: "partner_claim_fee", Type: (*PartnerClaimFeeInstruction)(nil),
		},
	},
)
