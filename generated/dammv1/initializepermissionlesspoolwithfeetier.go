...
type InitializePermissionlessPoolWithFeeTierInstruction struct {
	CurveType    *CurveType
	TradeFeeBps  *uint64
	TokenAAmount *uint64
	TokenBAmount *uint64
...
// NewInitializePermissionlessPoolWithFeeTierInstructionBuilder creates a new `InitializePermissionlessPoolWithFeeTierInstruction` instruction builder.
func NewInitializePermissionlessPoolWithFeeTierInstructionBuilder() *InitializePermissionlessPoolWithFeeTierInstruction {
	nd := &InitializePermissionlessPoolWithFeeTierInstruction{
...
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetCurveType(curve_type CurveType) *InitializePermissionlessPoolWithFeeTierInstruction {
	inst.CurveType = &curve_type
	return inst
}

// SetTradeFeeBps sets the "trade_fee_bps" parameter.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetTradeFeeBps(trade_fee_bps uint64) *InitializePermissionlessPoolWithFeeTierInstruction {
	inst.TradeFeeBps = &trade_fee_bps
	return inst
}

// SetTokenAAmount sets the "token_a_amount" parameter.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetTokenAAmount(token_a_amount uint64) *InitializePermissionlessPoolWithFeeTierInstruction {
	inst.TokenAAmount = &token_a_amount
	return inst
}

// SetTokenBAmount sets the "token_b_amount" parameter.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetTokenBAmount(token_b_amount uint64) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// Pool account (PDA address)
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetPoolAccount(pool ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// Pool account (PDA address)
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetPoolAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetLpMintAccount sets the "lp_mint" account.
// LP token mint of the pool
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetLpMintAccount(lpMint ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// LP token mint of the pool
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetLpMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetTokenAMintAccount sets the "token_a_mint" account.
// Token A mint of the pool. Eg: USDT
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetTokenAMintAccount(tokenAMint ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// Token A mint of the pool. Eg: USDT
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetTokenAMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetTokenBMintAccount sets the "token_b_mint" account.
// Token B mint of the pool. Eg: USDC
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetTokenBMintAccount(tokenBMint ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// Token B mint of the pool. Eg: USDC
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetTokenBMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetAVaultAccount sets the "a_vault" account.
// Vault account for token A. Token A of the pool will be deposit / withdraw from this vault account.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetAVaultAccount(aVault ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// Vault account for token A. Token A of the pool will be deposit / withdraw from this vault account.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetAVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetBVaultAccount sets the "b_vault" account.
// Vault account for token B. Token B of the pool will be deposit / withdraw from this vault account.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetBVaultAccount(bVault ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// Vault account for token B. Token B of the pool will be deposit / withdraw from this vault account.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetBVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetATokenVaultAccount sets the "a_token_vault" account.
// Token vault account of vault A
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetATokenVaultAccount(aTokenVault ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// Token vault account of vault A
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetATokenVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetBTokenVaultAccount sets the "b_token_vault" account.
// Token vault account of vault B
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetBTokenVaultAccount(bTokenVault ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// Token vault account of vault B
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetBTokenVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetAVaultLpMintAccount sets the "a_vault_lp_mint" account.
// LP token mint of vault A
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetAVaultLpMintAccount(aVaultLpMint ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// LP token mint of vault A
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetAVaultLpMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetBVaultLpMintAccount sets the "b_vault_lp_mint" account.
// LP token mint of vault B
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetBVaultLpMintAccount(bVaultLpMint ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// LP token mint of vault B
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetBVaultLpMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

// SetAVaultLpAccount sets the "a_vault_lp" account.
// LP token account of vault A. Used to receive/burn the vault LP upon deposit/withdraw from the vault.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetAVaultLpAccount(aVaultLp ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// LP token account of vault A. Used to receive/burn the vault LP upon deposit/withdraw from the vault.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetAVaultLpAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(10)
}

// SetBVaultLpAccount sets the "b_vault_lp" account.
// LP token account of vault B. Used to receive/burn vault LP upon deposit/withdraw from the vault.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetBVaultLpAccount(bVaultLp ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// LP token account of vault B. Used to receive/burn vault LP upon deposit/withdraw from the vault.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetBVaultLpAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(11)
}

// SetPayerTokenAAccount sets the "payer_token_a" account.
// Payer token account for pool token A mint. Used to bootstrap the pool with initial liquidity.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetPayerTokenAAccount(payerTokenA ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// Payer token account for pool token A mint. Used to bootstrap the pool with initial liquidity.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetPayerTokenAAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(12)
}

// SetPayerTokenBAccount sets the "payer_token_b" account.
// Admin token account for pool token B mint. Used to bootstrap the pool with initial liquidity.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetPayerTokenBAccount(payerTokenB ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// Admin token account for pool token B mint. Used to bootstrap the pool with initial liquidity.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetPayerTokenBAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(13)
}

// SetPayerPoolLpAccount sets the "payer_pool_lp" account.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetPayerPoolLpAccount(payerPoolLp ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
	inst.AccountMetaSlice[14] = ag_solanago.Meta(payerPoolLp).WRITE()
	return inst
}

// GetPayerPoolLpAccount gets the "payer_pool_lp" account.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetPayerPoolLpAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(14)
}

// SetProtocolTokenAFeeAccount sets the "protocol_token_a_fee" account.
// Protocol fee token account for token A. Used to receive trading fee.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetProtocolTokenAFeeAccount(protocolTokenAFee ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// Protocol fee token account for token A. Used to receive trading fee.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetProtocolTokenAFeeAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(15)
}

// SetProtocolTokenBFeeAccount sets the "protocol_token_b_fee" account.
// Protocol fee token account for token B. Used to receive trading fee.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetProtocolTokenBFeeAccount(protocolTokenBFee ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// Protocol fee token account for token B. Used to receive trading fee.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetProtocolTokenBFeeAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(16)
}

// SetPayerAccount sets the "payer" account.
// Admin account. This account will be the admin of the pool, and the payer for PDA during initialize pool.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetPayerAccount(payer ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// Admin account. This account will be the admin of the pool, and the payer for PDA during initialize pool.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetPayerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(17)
}

// SetFeeOwnerAccount sets the "fee_owner" account.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetFeeOwnerAccount(feeOwner ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
	inst.AccountMetaSlice[18] = ag_solanago.Meta(feeOwner)
	return inst
}

// GetFeeOwnerAccount gets the "fee_owner" account.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetFeeOwnerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(18)
}

// SetRentAccount sets the "rent" account.
// Rent account.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetRentAccount(rent ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// Rent account.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetRentAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(19)
}

// SetMintMetadataAccount sets the "mint_metadata" account.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetMintMetadataAccount(mintMetadata ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
	inst.AccountMetaSlice[20] = ag_solanago.Meta(mintMetadata).WRITE()
	return inst
}

// GetMintMetadataAccount gets the "mint_metadata" account.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetMintMetadataAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(20)
}

// SetMetadataProgramAccount sets the "metadata_program" account.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetMetadataProgramAccount(metadataProgram ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
	inst.AccountMetaSlice[21] = ag_solanago.Meta(metadataProgram)
	return inst
}

// GetMetadataProgramAccount gets the "metadata_program" account.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetMetadataProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(21)
}

// SetVaultProgramAccount sets the "vault_program" account.
// Vault program. The pool will deposit/withdraw liquidity from the vault.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetVaultProgramAccount(vaultProgram ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// Vault program. The pool will deposit/withdraw liquidity from the vault.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetVaultProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(22)
}

// SetTokenProgramAccount sets the "token_program" account.
// Token program.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetTokenProgramAccount(tokenProgram ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// Token program.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetTokenProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(23)
}

// SetAssociatedTokenProgramAccount sets the "associated_token_program" account.
// Associated token program.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetAssociatedTokenProgramAccount(associatedTokenProgram ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// Associated token program.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetAssociatedTokenProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(24)
}

// SetSystemProgramAccount sets the "system_program" account.
// System program.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) SetSystemProgramAccount(systemProgram ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
...
// System program.
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) GetSystemProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(25)
}

func (inst InitializePermissionlessPoolWithFeeTierInstruction) Build() *Instruction {
...
func (inst InitializePermissionlessPoolWithFeeTierInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) Validate() error {
...
func (inst *InitializePermissionlessPoolWithFeeTierInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj InitializePermissionlessPoolWithFeeTierInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *InitializePermissionlessPoolWithFeeTierInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
...
func NewInitializePermissionlessPoolWithFeeTierInstruction(
	...
	systemProgram ag_solanago.PublicKey) *InitializePermissionlessPoolWithFeeTierInstruction {
	return NewInitializePermissionlessPoolWithFeeTierInstructionBuilder().
		SetCurveType(curve_type).
		SetTradeFeeBps(trade_fee_bps).
