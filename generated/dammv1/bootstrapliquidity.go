...
type BootstrapLiquidityInstruction struct {
	TokenAAmount *uint64
	TokenBAmount *uint64
...
// NewBootstrapLiquidityInstructionBuilder creates a new `BootstrapLiquidityInstruction` instruction builder.
func NewBootstrapLiquidityInstructionBuilder() *BootstrapLiquidityInstruction {
	nd := &BootstrapLiquidityInstruction{
...
func (inst *BootstrapLiquidityInstruction) SetTokenAAmount(token_a_amount uint64) *BootstrapLiquidityInstruction {
	inst.TokenAAmount = &token_a_amount
	return inst
}

// SetTokenBAmount sets the "token_b_amount" parameter.
func (inst *BootstrapLiquidityInstruction) SetTokenBAmount(token_b_amount uint64) *BootstrapLiquidityInstruction {
...
// Pool account (PDA)
func (inst *BootstrapLiquidityInstruction) SetPoolAccount(pool ag_solanago.PublicKey) *BootstrapLiquidityInstruction {
...
// Pool account (PDA)
func (inst *BootstrapLiquidityInstruction) GetPoolAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetLpMintAccount sets the "lp_mint" account.
// LP token mint of the pool
func (inst *BootstrapLiquidityInstruction) SetLpMintAccount(lpMint ag_solanago.PublicKey) *BootstrapLiquidityInstruction {
...
// LP token mint of the pool
func (inst *BootstrapLiquidityInstruction) GetLpMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetUserPoolLpAccount sets the "user_pool_lp" account.
// user pool lp token account. lp will be burned from this account upon success liquidity removal.
func (inst *BootstrapLiquidityInstruction) SetUserPoolLpAccount(userPoolLp ag_solanago.PublicKey) *BootstrapLiquidityInstruction {
...
// user pool lp token account. lp will be burned from this account upon success liquidity removal.
func (inst *BootstrapLiquidityInstruction) GetUserPoolLpAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetAVaultLpAccount sets the "a_vault_lp" account.
// LP token account of vault A. Used to receive/burn the vault LP upon deposit/withdraw from the vault.
func (inst *BootstrapLiquidityInstruction) SetAVaultLpAccount(aVaultLp ag_solanago.PublicKey) *BootstrapLiquidityInstruction {
...
// LP token account of vault A. Used to receive/burn the vault LP upon deposit/withdraw from the vault.
func (inst *BootstrapLiquidityInstruction) GetAVaultLpAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetBVaultLpAccount sets the "b_vault_lp" account.
// LP token account of vault B. Used to receive/burn the vault LP upon deposit/withdraw from the vault.
func (inst *BootstrapLiquidityInstruction) SetBVaultLpAccount(bVaultLp ag_solanago.PublicKey) *BootstrapLiquidityInstruction {
...
// LP token account of vault B. Used to receive/burn the vault LP upon deposit/withdraw from the vault.
func (inst *BootstrapLiquidityInstruction) GetBVaultLpAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetAVaultAccount sets the "a_vault" account.
// Vault account for token a. token a of the pool will be deposit / withdraw from this vault account.
func (inst *BootstrapLiquidityInstruction) SetAVaultAccount(aVault ag_solanago.PublicKey) *BootstrapLiquidityInstruction {
...
// Vault account for token a. token a of the pool will be deposit / withdraw from this vault account.
func (inst *BootstrapLiquidityInstruction) GetAVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetBVaultAccount sets the "b_vault" account.
// Vault account for token b. token b of the pool will be deposit / withdraw from this vault account.
func (inst *BootstrapLiquidityInstruction) SetBVaultAccount(bVault ag_solanago.PublicKey) *BootstrapLiquidityInstruction {
...
// Vault account for token b. token b of the pool will be deposit / withdraw from this vault account.
func (inst *BootstrapLiquidityInstruction) GetBVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetAVaultLpMintAccount sets the "a_vault_lp_mint" account.
// LP token mint of vault a
func (inst *BootstrapLiquidityInstruction) SetAVaultLpMintAccount(aVaultLpMint ag_solanago.PublicKey) *BootstrapLiquidityInstruction {
...
// LP token mint of vault a
func (inst *BootstrapLiquidityInstruction) GetAVaultLpMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetBVaultLpMintAccount sets the "b_vault_lp_mint" account.
// LP token mint of vault b
func (inst *BootstrapLiquidityInstruction) SetBVaultLpMintAccount(bVaultLpMint ag_solanago.PublicKey) *BootstrapLiquidityInstruction {
...
// LP token mint of vault b
func (inst *BootstrapLiquidityInstruction) GetBVaultLpMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetATokenVaultAccount sets the "a_token_vault" account.
// Token vault account of vault A
func (inst *BootstrapLiquidityInstruction) SetATokenVaultAccount(aTokenVault ag_solanago.PublicKey) *BootstrapLiquidityInstruction {
...
// Token vault account of vault A
func (inst *BootstrapLiquidityInstruction) GetATokenVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

// SetBTokenVaultAccount sets the "b_token_vault" account.
// Token vault account of vault B
func (inst *BootstrapLiquidityInstruction) SetBTokenVaultAccount(bTokenVault ag_solanago.PublicKey) *BootstrapLiquidityInstruction {
...
// Token vault account of vault B
func (inst *BootstrapLiquidityInstruction) GetBTokenVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(10)
}

// SetUserATokenAccount sets the "user_a_token" account.
// User token A account. Token will be transfer from this account if it is add liquidity operation. Else, token will be transfer into this account.
func (inst *BootstrapLiquidityInstruction) SetUserATokenAccount(userAToken ag_solanago.PublicKey) *BootstrapLiquidityInstruction {
...
// User token A account. Token will be transfer from this account if it is add liquidity operation. Else, token will be transfer into this account.
func (inst *BootstrapLiquidityInstruction) GetUserATokenAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(11)
}

// SetUserBTokenAccount sets the "user_b_token" account.
// User token B account. Token will be transfer from this account if it is add liquidity operation. Else, token will be transfer into this account.
func (inst *BootstrapLiquidityInstruction) SetUserBTokenAccount(userBToken ag_solanago.PublicKey) *BootstrapLiquidityInstruction {
...
// User token B account. Token will be transfer from this account if it is add liquidity operation. Else, token will be transfer into this account.
func (inst *BootstrapLiquidityInstruction) GetUserBTokenAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(12)
}

// SetUserAccount sets the "user" account.
// User account. Must be owner of user_a_token, and user_b_token.
func (inst *BootstrapLiquidityInstruction) SetUserAccount(user ag_solanago.PublicKey) *BootstrapLiquidityInstruction {
...
// User account. Must be owner of user_a_token, and user_b_token.
func (inst *BootstrapLiquidityInstruction) GetUserAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(13)
}

// SetVaultProgramAccount sets the "vault_program" account.
// Vault program. the pool will deposit/withdraw liquidity from the vault.
func (inst *BootstrapLiquidityInstruction) SetVaultProgramAccount(vaultProgram ag_solanago.PublicKey) *BootstrapLiquidityInstruction {
...
// Vault program. the pool will deposit/withdraw liquidity from the vault.
func (inst *BootstrapLiquidityInstruction) GetVaultProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(14)
}

// SetTokenProgramAccount sets the "token_program" account.
// Token program.
func (inst *BootstrapLiquidityInstruction) SetTokenProgramAccount(tokenProgram ag_solanago.PublicKey) *BootstrapLiquidityInstruction {
...
// Token program.
func (inst *BootstrapLiquidityInstruction) GetTokenProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(15)
}

func (inst BootstrapLiquidityInstruction) Build() *Instruction {
...
func (inst BootstrapLiquidityInstruction) ValidateAndBuild() (*Instruction, error) {
...
func (inst *BootstrapLiquidityInstruction) Validate() error {
...
func (inst *BootstrapLiquidityInstruction) EncodeToTree(parent ag_treeout.Branches) {
...
func (obj BootstrapLiquidityInstruction) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *BootstrapLiquidityInstruction) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
...
func NewBootstrapLiquidityInstruction(
	...
	tokenProgram ag_solanago.PublicKey) *BootstrapLiquidityInstruction {
